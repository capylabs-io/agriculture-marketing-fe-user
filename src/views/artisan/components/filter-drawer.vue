    ...
    <div class="pa-6">
      ...
      <v-list>
        <v-list-item
          ...
          :class="{ 'active-item': !artisanStore.filterCategory }"
          @click="artisanStore.filterCategory = null"
          dense
        >
        ...
        <v-list-item
          ...
          :class="{ 'active-item': artisanStore.filterCategory == category }"
          :key="category.id"
          @click="artisanStore.filterCategory = category"
          dense
        >
          <v-list-item-title class="text-capitalize text-sm">{{
            category.name
